...
<head>
    ...
    <title>Facial Attendance System - Liên hệ</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="content">            
            <p><strong>Email liên hệ chung</strong></p>
            <p><a href="mailto:support@attendancesystem.com">support@attendancesystem.com</a></p>

            <p><strong>Địa chỉ</strong></p>
            <p>
                Đại học Bách Khoa - Đại học Đà Nẵng<br>
                54 Nguyễn Lương Bằng, Hòa Khánh Bắc<br>
                Liên Chiểu, Đà Nẵng, Việt Nam
            </p>

            <p><strong>Điện thoại liên hệ</strong></p>
            <p>+84 123 456 789 (Điện thoại)<br>+84 987 654 321 (Fax)</p>
        </div>
    </div>
